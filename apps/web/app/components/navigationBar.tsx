...
export async function NavigationBar({ categoryArray }: { categoryArray?: string[] }) {
    const session = await auth()
    console.log("session form navbar: ",session);
                ...
                <div className="flex gap-x-6 gap-y-4 ml-auto">
                    ...
                    <div className='flex items-center space-x-8'>
                        ...
                        {session && (
                            ...
                            >
                                <Button size="sm" type="submit" className='px-5 text-xs pt-1 rounded-full'>
                                    Sign Out
                                </Button>
                            </form>
