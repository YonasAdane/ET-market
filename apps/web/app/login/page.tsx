        ...
        <Card className="flex bg-blur-lg backdrop-filter bg-slate-100/5 rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
            ...
            <div className="w-full p-8 lg:w-1/2">
                ...
                <p className="text-xl text-gray-600 text-center">Welcome back!</p>
                  <Button variant={"ghost"} className="flex w-full items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                ...
                <div className="mt-8">
                    <Button className="  py-2 px-4 w-full font-bold">Login</Button>
                </div>
                <div className="mt-4 flex items-center justify-between">
